...
rm -f /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.7.2/wcofs_da_*_03.out
rm -f /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.7.2/wcofs_da_*_03.err
PREP=$(qsub $LSFDIR/jnos_wcofs_da_prep_03.pbs) 
OBS=$(qsub -W depend=afterok:$PREP $LSFDIR/jnos_wcofs_da_obs_03.pbs) 
qsub -W depend=afterok:$OBS $LSFDIR/jnos_wcofs_da_nowcst_fcst_03.pbs 
