...
rm -f /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.7.2/sscofs_*_15.out
rm -f /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.7.2/sscofs_*_15.err
export LSFDIR=/lfs/h1/nos/nosofs/noscrub/aijun.zhang/packages/nosofs.v3.7.2/pbs 
PREP=$(qsub  $LSFDIR/jnos_sscofs_prep_15.pbs) 
NFRUN=$(qsub -W depend=afterok:$PREP $LSFDIR/jnos_sscofs_nowcst_fcst_15.pbs)
qsub -W depend=afterok:$NFRUN $LSFDIR/jnos_sscofs_aws_15.pbs
